...
export const translations = {
  ...
  aboutText: {
    ...
    about: {
      "pt-br":
        "Engenheiro de Software | +3 anos de experiência | TypeScript • Node.js • JavaScript • Python • AWS\n\nDesenvolvo sistemas de ponta a ponta unindo a agilidade do ecossistema JavaScript/TypeScript à versatilidade do Python. Minha trajetória inclui a liderança técnica de MVPs em ambientes de Startup e a sustentação de sistemas maduros, atuando diretamente em refatorações, melhorias contínuas, correções de bugs e novas funcionalidades.\n\nEspecialista em arquitetura Serverless (AWS), automação de deploys e integração de sistemas. Orientado a boas práticas, aplico conceitos de Clean Code e estudo constantemente padrões arquiteturais como DDD, Microsserviços, Monorepos, modularização e containers para criar softwares resilientes e escaláveis.",
      en: "Software Engineer | +3 years of experience | TypeScript • Node.js • JavaScript • Python • AWS\n\nI develop end-to-end systems by combining the agility of the JavaScript/TypeScript ecosystem with the versatility of Python. My background includes leading MVPs from scratch in startup environments as well as maintaining mature systems, working directly with refactoring, continuous improvements, bug fixes, and new feature implementation.\n\nSpecialized in Serverless architecture (AWS), deploy automation, and API integrations. Driven by software development best practices, I apply Clean Code principles and constantly study architectural patterns such as DDD, Microservices, Monorepos, modularization, and containers to build resilient and scalable software.",
    },
  },
